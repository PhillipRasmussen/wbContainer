...
<cfoutput>
	<div class="ruleadmin clearfix">
		...
		<div style="float:left;padding:2px;">
			<span style="display:inline-block;margin-right:0;cursor:grab" class="ui-icon ui-icon-arrowthick-2-n-s" ></span> <span style="display:inline-block;margin-left:20px" class="ui-icon ui-icon-wrench"></span> #ruleDisplayName#
		</div>	
		<skin:toolTip selector=".ui-icon-arrowthick-2-n-s">Move this Rule around.</skin:toolTip>
